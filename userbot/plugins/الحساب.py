...
BIO_SUCCESS = "** ⪼ تم تغير بايو وقتي حسابك بنجاح 𓆰،**"
NAME_OK = "** ⪼ تم تغير اسم وقتي حسابك بنجاح 𓆰،**"
...
@bot.on(admin_cmd(pattern=" بايو وقتي (.*)"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
async def count(event):
    ...
    result += f"𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉 - 𝑷𝑹𝑶𝑭𝑰𝑳 𝑫𝑨𝑻𝑨 𓆪\n"
...
\n\n.اسم وقتي الاسم الاول / .اسم وقتي الاسم الاول + الاسم الثاني\
