...
Heroku_cmd = (
    "𓆰 [𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉 - هيـروكو الفـارات](t.me/olixXx1) 𓆪\n"
    "**⌔∮ قائـمه اوامر هيروكو :** \n"
    "⪼ `.ضع فار` + الفار + المتغير\n"
    "⪼ `.جلب فار` + الفار لعرض ما في المتغير \n"
    "⪼ `.حذف فار` + الفار لحذف الفار \n"
    "⪼ `.استخدامي` \n"
    "\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉](t.me/RolixXx1) 𓆪"
)
...
async def variable(var):
    ...
    if exe == "جلب":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(
                    "𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉 - 𝑮𝑺𝑶𝑼𝑹𝑪𝑬 𝙍𝙊𝙇𝙄𝙓𝙃𝙊𝙉𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
                    f"\n **⌔∮** `{variable} = {heroku_var[variable]}` .\n"
                )
            return await ics.edit(
                "𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
                f"\n **⌔∮ خطا :**\n-> {variable} غيـر موجود. "
            )
        except IndexError:
        ...
        if variable in heroku_var:
            await ics.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت تلثون روليكس يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await ics.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بوت تلثون روليكس يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
async def variable(var):
    ...
    if exe == "get":
        ...
        await ics.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت تلثون روليكس يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
        del heroku_var[variable]
...
async def dyno_usage(dyno):
    ...
    return await dyno.edit(
        "𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉 - 𝑫𝒀𝑺𝑶𝑼𝑹𝑪𝑬 𝙍𝙊𝙇𝙄𝙓𝙏𝙃𝙊𝙉𝑵𝑶 𝑼𝑺𝑨𝑮𝑬 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/RolixXx1)**"
        )
    data = app.get_log()
    await edit_or_reply(
