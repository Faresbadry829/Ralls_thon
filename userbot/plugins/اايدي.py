...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مطـور السورس 𓄂𓆃 」." if user_id == 2019189055 or user_id == 1290321198 or user_id == 1337732405 or user_id == 1985220043 or user_id == 1355571767 or user_id == 1355571767 or user_id == 1649357121 or user_id == 82894620 or user_id == 1850008091 or user_id == 1691343402 or user_id == 1933191679 or user_id == 1993573528 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 2019189055 and user_id != 1290321198 and user_id != 1337732405 and user_id != 1985220043 and user_id != 1355571767 and user_id != 1355571767 and user_id != 1649357121 and user_id != 82894620 and user_id != 1850008091 and user_id != 1691343402 and user_id != 1933191679 and user_id != 1993573528 else rotbat
