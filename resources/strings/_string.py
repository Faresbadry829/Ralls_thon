...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس تلثون روليكس
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝙍𝙊𝙇𝙄𝙓 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝙍𝙊𝙇𝙄𝙓**─━─━─━─━◐\n"
    "**⌔╎ اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝙍𝙊𝙇𝙄𝙓**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝙍𝙊𝙇𝙄𝙓 - [𝘿𝙀𝙑](t.me/RolixXx1) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - Rolix PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - Rolix ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - Rolix TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - Rolix ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - Rolix ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - Rolix ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
⫷ بوت تلثون روليكس يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @RolixXx1 - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @YY_YPY - تحياتي : روليكس  ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين تلثون روليكس ⫸',
    '⫷ اكتمل تنزيل انلاين تلثون روليكس بدون اخطاء ⫸',
    '⫷ يتم بدء بوت تلثون روليكس ⫸',
    '⫷ اكتمل بدء بوت تلثون روليكس ⫸'
]
